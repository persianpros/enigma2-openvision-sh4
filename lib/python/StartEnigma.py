...
print("[StartEnigma] Source Brand = %s" % brand)
print("[StartEnigma] Brand = %s" % BoxInfo.getItem("displaybrand"))
print("[StartEnigma] Source Model = %s" % model)
print("[StartEnigma] Model = %s" % BoxInfo.getItem("displaymodel"))
